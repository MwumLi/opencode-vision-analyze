...
- **Image store unbounded** — the image store has no eviction (git-project-scoped or user-cache-scoped). The description cache is bounded (2000 entries / 50 MB LRU).
